...
export default function Home(){
  ...
  const refreshMarkers = () => {
    ...
    const allChange = (e:any, allergen:string) =>{
      ...
      else  setAllergens(prevAllergens => prevAllergens.filter(a => a !== allergen));
    }
...
<rect className=" h-36 w-52 flex flex-col justify-start  bg-slate-800 text-white">
                ...
                <div className=" flex flex-row justify-start my-1 mx-3">
                    <input type="checkbox" id="Lactose" onClick={(e) => allChange(e, 'Lactose')}></input>
                    <label htmlFor="Lactose" className="mx-2">Lactose </label>
                    
                    <div className="right-allergen">
                    <input type="checkbox" id="Peanuts" onClick={(e) => allChange(e, 'Peanut')}></input>
                    <label htmlFor="Peanuts" className="mx-2">Peanut </label>
                    </div>
                </div>
                <div className=" flex flex-row justify-start my-1 mx-3">
                    <input type="checkbox" id="Meat" onClick={(e) => allChange(e, 'Meat')}></input>
                    <label htmlFor="Meat" className="mx-2">Meat </label>

                    <div className="right-allergen">
                    <input type="checkbox" id="Wheat" onClick={(e) => allChange(e, 'Wheat')}></input>
                    <label htmlFor="Wheat" className="mx-2">Wheat </label>
                    </div>
                </div>
                
                <div className=" flex flex-row justify-start my-1 mx-3">
                <input type="checkbox" id="Gluten" onClick={(e) => allChange(e, 'Gluten')}></input>
                <label htmlFor="Gluten" className="mx-2">Gluten</label>
                <div className="right-allergen">
                <input type="checkbox" id="Egg" onClick={(e) => allChange(e, 'Egg')}></input>
                <label htmlFor="Egg" className="mx-2">Egg</label>
                </div>
                </div>
                <div className=" flex flex-row justify-start my-1 mx-3">
                <input type="checkbox" id="Crustacean" onClick={(e) => allChange(e, 'Crustacean')}></input>
                <label htmlFor="Crustacean" className="mx-2">Crustacean</label>
                <div className="right-allergen">
                <input type="checkbox" id="Soy" onClick={(e) => allChange(e, 'Soy')}></input>
                <label htmlFor="Soy" className="mx-2">Soy</label>
                </div>
                </div>
                </rect>
</div>
<GoogleMap mapContainerClassName="map-Style" onLoad={onMapLoad} center={center} zoom={12} options={{zoomControl:false, streetViewControl:false, mapTypeControl: false, fullscreenControl: false, styles: blueEssenceStyle,}}>
{markers}
</GoogleMap>
  </div>
  );
